...
export const NO_ANSWERS = 'No answer found for this question';
...
export const NO_RELATED = 'No match found';
export const MATCH_FOUND = 'Related match retrieved successfully';
